...
- Where will failure start?
- How fast will flood water travel?
- Which villages will be affected?
- How much evacuation time is available?

### Step 6 — Risk Prediction Output
The system generates:
- Risk level (Low / Medium / High)
- Time before possible breach
- Flood path
- Affected zones

### Step 7 — Targeted Alerts
Alerts are sent **only to danger zones** via:
- SMS alerts
